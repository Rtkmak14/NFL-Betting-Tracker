...
from . import views
from .views import NoteListView, NoteDetailView, NoteCreateView, NoteUpdateView, NoteDeleteView, team_travel_view
...
urlpatterns = [
    ...
    path('test-travel/', team_travel_view, name='test_travel')
]
